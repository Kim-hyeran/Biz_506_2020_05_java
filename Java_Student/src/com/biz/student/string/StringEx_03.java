...
public class StringEx_03 {
	...
	public static void main(String[] args) {
		...
		//문자열을 알파벳 단위로 쪼개기
		strNations=strNation.split("");	//("") : null
		...
		//문자열을 빈칸 단위로 쪼개기
		strNations=strNation.split(" ");	//(" ") : space
		for(String s:strNations) {
			System.out.print(s+"\t");
		}
		...
		String score="1, 76, 58, 67, 201, 67";
		...
		/*
		 * 단위(모듈) test
		 * score.csv 파일을 읽어서 코드를 검증하고, 모든 결과가 일치로 나타나는지 판단하는 것
		 * 이 때 사용된 score.csv 파일의 데이터를 TestCase라고 한다
		 */
